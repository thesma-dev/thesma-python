...
@click.option("--to", "to_date", default=None, help="Filter events on or before this date (YYYY-MM-DD).")
...
def events_list(
    ...
    result = client.events.list(
        cik, from_date=from_date, to_date=to_date, category=category, page=page, per_page=per_page
    )
